...
class Sales extends REST_Controller {
    ...
    /**
     * @api {get} /sales/list 매출관리
     * @apiHeader {string} x-api-key="qJqKDATY0D48ZH9hCNW4N6ygHBqtoVz4a4mu0P6A"
     * @apiSampleRequest /api/v1.0/sales/list
     * @apiVersion 1.0.0
     * @apiName sales list
     * @apiGroup Sales
     * @apiDescription 매출 리스트
     * @apiParam {String} token 토큰
     * @apiParam {String} users_id 회원번호
     ...
     * @apiSuccess (200) {Object[]} result 배열. 회원리스트
     *
